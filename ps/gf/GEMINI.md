...
- **Multiple Display Modes:**
  ...
  - **Observations Mode (`-o` or `-observations`):** Shows historical weather observations for the last 7 days with sunrise/sunset/day length for each day and daily aggregates
