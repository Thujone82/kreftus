...
- **[TemPy v1.8](tp/)** — Cross-platform Python TUI for ThermoPro TP357/TP358/TP359 Bluetooth hygrometers. Incremental minute-history polling, live dashboard sparklines (4H/24H/72H), **history fetch** up to 1 year from sensor memory, log export to web, and CSV logging. [README](python/tp/README.md)
...
This project demonstrates the collaborative potential between human developers and AI tools. Contributions are welcome, and the repository serves as a living example of AI-assisted software development.
