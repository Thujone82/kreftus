...
- **[TemPy v1.5](tp/)** — Cross-platform Python TUI for ThermoPro TP357/TP358/TP359 Bluetooth hygrometers. Live 24h sparklines, scheduled BLE polling, **24H history fetch** from on-sensor memory, automatic sparkline backfill when logging is off, and CSV logging. [README](python/tp/README.md)
