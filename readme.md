...
- **[png2ico v1.0](png2ico/)** — Python CLI that converts a 256×256 PNG into a Windows ICO containing the common icon sizes (16–256). [README](python/png2ico/README.md)
