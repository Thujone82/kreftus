...
- **Color-Coded Metrics**: Temperature, wind, precipitation, humidity, dew point, pressure, wildfire (acres, cost, labels, behavior)
...
- **Station observation:** `GET /stations/{stationId}/observations/latest` (one small GeoJSON feature).
