...
- `render_test.go` — solved overlay uses **Perfect Finish!** at 0 mistakes and colon-aligns Time / Errors otherwise; Shift+digit symbols map to 1–9; NumLock+Shift keypad nav keys map to 1–9 and stay pencil-active through Windows' fake Shift-up; pause progress bar and Pencil Marks / Errors line.
