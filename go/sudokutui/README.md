...
- **Solved** — joined double-line frame (accent, accent+5 title bar, accent−5 title text and hint). The rainbow SUDOKU banner rotates its hues at 5 fps while playback runs. Left: **Hard Solved!** (or Easy / Medium / Diabolical); Time and **Errors**, or **Perfect Finish!** when there were none; **New Best Completion!** or **New Fastest Completion!** when this run is the new record (Best until a perfect exists, then Fastest). Right: a borderless 9×9 playback of the run compressed into 5 seconds, then the solved digits cycle their hues at 5 fps for 3 seconds before looping
